...
export function LocationMap({
  ...
  return (
    ...
    >
      <motion.div
        layout
        className="relative overflow-hidden rounded-2xl bg-[#0F0F12] border border-white/5 shadow-2xl"
        style={{
      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-6">
          ...
          <div className="flex items-start justify-between">
            ...
            <motion.div
              layout
              className={`flex items-center gap-1.5 px-3 py-1 rounded-full backdrop-blur-md ${status.includes('FECHADO') ? 'bg-red-500/10 border border-red-500/20' : 'bg-white/5 border border-white/10 shadow-lg'}`}
            >
